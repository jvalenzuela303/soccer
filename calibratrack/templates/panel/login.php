...
<div class="ct-login-wrap">
	<div class="ct-login-box">
		<div class="ct-login-brand">
			...
			<p class="ct-login-subtitle"><?php esc_html_e( 'Panel de acceso', 'calibratrack' ); ?></p>
		</div>
		...
		<form method="post" action="<?php echo esc_url( home_url( '/panel/login/' ) ); ?>" class="ct-login-form" novalidate>
